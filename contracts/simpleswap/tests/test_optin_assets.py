...
class OptinAssetsTestCase(BaseTestCase):
    ...
    def test_optin_assets(self):
        ...
        self.assertTrue("asset-id-from" in app_global_state.keys())
        self.assertTrue("asset-id-to"   in app_global_state.keys())
        ...
        self.assertEqual(self.sm_creator_addr, admin_addr)
